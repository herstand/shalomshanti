...
.modalWrapper .modal { text-align:center; width:calc(100vw - 13.33vw); max-width:415px; height:410px; background:white; margin:0 auto; position:relative; left:0; top:50%; margin-top:-205px; padding:40px 6.67vw; }
