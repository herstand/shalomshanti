...
form.login input { outline:none; height:30px; border:2px solid <?php echo $grey; ?>; width:180px; padding-left:10px; padding-top:2px; }
form.login button { outline:none; margin:0px; position:relative; }
form.login button,
form.login button svg { width:30px; height:30px; }
form.login button svg { position:absolute; left:0px; top:0px; }
