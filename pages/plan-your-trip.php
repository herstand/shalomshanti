...
<script type='text/javascript' src="/js/plan.js?cache=5"></script>
<link rel="stylesheet" type="text/css" href="/css/plan.css?cache=5" />
        ...
        ?><section class="list pageSection">
            ...
            <section class="infoSection" id="wheretoeat"><hr class="jumpToPoint" id="wheretoeat-anchor" /><?php
                ...
                ?><article>
                    ...
                    <p class="typ-body">From firehouse to steakhouse, this building has been serving Greater Binghamton for nearly <span class="nobreak">120 years.</span></p><p class="typ-body"><a target="_blank" href="http://number5restaurant.com">number5restaurant.com</a></p>
                </article><?php
            ?></section>
            <hr />
